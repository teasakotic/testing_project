...
public class ClientDAOTest {
    ...
    @Before
    public void setUp() {
        client = new Client(1, "Teodora", "Tea555", "123");
    ...
    public void testUpdateName() {
        ...
        String clientName = "Teodora";
        String clientUsername = "Tea1";
        String clientPassword = "123";
        
        String clientAfterChangeName = "Tea";
    ...
    public void testUpdateUsername() {
        ...
        int clientId = testNumber;
        String clientName = "Teodora";
        String clientUsername = "Tea2";
        String clientPassword = "123";
        
        String clientAfterChangeUsername = "Tea3";
        client = new Client(clientId, clientName, clientUsername, clientPassword);
        clientDAO.insertOne(client);
