...
public class TransactionDAOTest {
    ...
    public void getOneTest() {
        ...
        Client c = new Client(testNumber,"Teodora555","Teodora555","Teodora555");
    ...
    public void getAllTest() {
        ...
        boolean expResult = true;
        Client c = new Client(testNumber,"Teodora998","Teodora998","Teodora998");
        DeliveryService d = new DeliveryService(testNumber,"DS",50.0f,55.0f);
        ShopItem s = new ShopItem(testNumber,"ItemShop", 350.0f, 30);
        cdao.insertOne(c);
        dsdao.insertOne(d);
    ...
    public void deleteOneTest() {
        ...
        boolean expResult = true;
        Client c = new Client(testNumber,"Teodora100","Teodora100","Teodora100");
        DeliveryService d = new DeliveryService(testNumber,"DS",50.0f,55.0f);
        ShopItem s = new ShopItem(testNumber,"ItemShop", 350.0f, 30);
        cdao.insertOne(c);
        dsdao.insertOne(d);
